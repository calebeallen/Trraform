...
<div class="overflow-auto bg-grad">
    <div class="w-full max-w-screen-md px-2 mx-auto my-32 space-y-3">
        ...
        <h2>Introduction</h2>
        <p>This Privacy Policy describes the Privacy practices of Trraform (“we”, “us”, “our”, “our platform”) in connection to any of our services. This Privacy Policy outlines how we handle data related to your use of our services. Please read this privacy notice carefully and thoroughly as it is crucial that you understand how your data will be handled though your use of any of our services.</p>
        <p>By visiting our website, or using any other related service, you agree to this privacy policy. If you do not agree with the terms listed in this policy. Do not use our services. Please review our <a target="_blank" href="/terms-of-service">Terms of Service</a> as well.</p>
        ...
        <p><b>Personal Data:</b> Information that identifies or can be linked to an individual. It excludes aggregated or anonymized data that cannot identify a specific person. References to "Personal Data" in this Privacy Policy include its definition under the Data Protection Act 2018.</p>
        <p><b>Cookies:</b> Small text files stored on your device by a website to remember your preferences, enhance functionality, and analyze usage.</p>
        <p><b>Local Storage:</b> A browser-based storage mechanism that retains data on your device to provide a faster and more personalized user experience.</p>
        ...
        <p>Trraform permits users 13 and older to use our services with restrictions to features that require users to connect an Ethereum wallet. Users who submit user generated content to our platform must have a connected Ethereum wallet and therefore must be 18 years or older. We do not knowingly collect or process personal data from minors. Users are strictly advised not to upload content containing personal or sensitive information, including information related to minors.</p>
        ...
        <p>For mobile devices, refer to your device’s instruction manual or help resources to manage cookie settings. Additional information about cookies and how to disable them can be found at <a target="_blank" href="https://www.allaboutcookies.org">allaboutcookies.org</a>.</p>
        ...
        <p>To provide our services, we may store, process, or transfer your data (see “Data We Collect” for specifics on what types of data is transferred) to servers located in other countries depending on the third-party providers we use (e.g., hosting and content delivery services) such as Cloudflare.</p>
        ...
        <h2>Contact</h2>
        <p>For questions and concerns regarding this Privacy Policy, you can contact us by email through trraformsupport@gmail.com or through discord. If you are concerned that we have not complied with your legal rights or privacy laws including GDPR or CCPA laws, you may contact us or your local data protection authority.</p>
